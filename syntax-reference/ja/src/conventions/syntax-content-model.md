...
| Expression primary: parenthesized form | [parenthesized expressions](../expressions/parenthesized-expression.md)。parenthesesとseparator | `OperatorChain` | `ParenthesizedExpression`。0個以上の直接の`OperatorChain`要素を含む。primaryは最大1個 | `notes/design/2026-08-20-yu-syntax-chasa-architecture.md` §§ “Grammar”, “Parser-side AST and CST shape” (4099–4351) |
