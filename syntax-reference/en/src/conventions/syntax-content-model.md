...
| Expression primary: parenthesized form | [parenthesized expressions](../expressions/parenthesized-expression.md); parentheses/separators | `OperatorChain` | `ParenthesizedExpression`, containing 0 or more direct `OperatorChain` elements; at most 1 primary | `notes/design/2026-08-20-yu-syntax-chasa-architecture.md` §§ “Grammar”, “Parser-side AST and CST shape” (4099–4351) |
