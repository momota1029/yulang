...
append_key_metrics() {
    ...
    {
        printf '\n## Key metrics\n\n'
        printf '| workload | wall(s) | cache route | infer | constraint.drain | constraint epoch | replay accepted | replay duplicate | top restart root | top restarts | top epoch delta | runtime execute | marker touches | active scans |\n'
        printf '| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |\n'
