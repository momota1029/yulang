...
- `archive/notes/progress/daily/2026-05-28-parallel-cache-flake-handoff.md`
- `archive/notes/progress/daily/2026-05-26-infer-monomorphize-handoff.md`
- `archive/notes/refactors/finalized-vm-handoff-2026-05-25.md`
...
- `archive/notes/design/algebraic-effect-optimization-plan.md`
- `notes/bugs/type-substitute.md`
- `notes/bugs/type-monomorphize.md`
- `notes/bugs/type-monorphized-refactor.md`
...
- 詳細な実装履歴は `tasks/done/2026-05-14-native-backend-history.md` と
  `archive/notes/refactors/finalized-vm-handoff-2026-05-25.md` を見る。
