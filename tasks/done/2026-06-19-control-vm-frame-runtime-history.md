# Control VM frame runtime history

この文書は、`tasks/current.md` の「今すぐやる slice」に残っていた
2026-06-17〜2026-06-19 の control VM frame runtime / performance 作業ログを退避したもの。

退避時点の現行戦線は Contract v1 / host resource / diagnostics / server driver へ移っている。
ここに残る記録は、control VM hot path の履歴や再測定が必要なときだけ参照する。

## 2026-06-17〜2026-06-19: control VM frame runtime slice
