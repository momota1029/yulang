...
map one concrete unpinned wrong-head scalar disposition before selecting its
source/result, then receive a pre-write specification audit before adding that
