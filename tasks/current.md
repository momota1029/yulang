...
complete.  Its immediate next action is to map one concrete remaining
fence-qualified scalar source/result before selecting another direct-evidence
slice, then receive a pre-write specification audit before adding it; its
