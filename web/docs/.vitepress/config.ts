  ...
  "/reference/": [
    {
      ...
      items: [
        ...
        { text: "Parser DSL", link: "/reference/parser-dsl" },
    ...
    },
    {
      ...
      items: [
        ...
        { text: "std::text::yumark", link: "/reference/std/yumark" },
        { text: "std::data::opt", link: "/reference/std/opt" },
        { text: "std::data::result", link: "/reference/std/result" },
        { text: "std::io::file", link: "/reference/std/fs" },
        { text: "std::control::nondet", link: "/reference/std/nondet" },
        { text: "std::testing", link: "/reference/std/testing" },
        { text: "std::time", link: "/reference/std/time" },
      ],
    },
  ],
};
  ...
  "/ja/reference/": [
    {
      ...
      items: [
        ...
        { text: "Parser DSL", link: "/ja/reference/parser-dsl" },
    ...
    },
    {
      ...
      items: [
        ...
        { text: "std::text::yumark", link: "/ja/reference/std/yumark" },
        { text: "std::data::opt", link: "/ja/reference/std/opt" },
        { text: "std::data::result", link: "/ja/reference/std/result" },
        { text: "std::io::file", link: "/ja/reference/std/fs" },
        { text: "std::control::nondet", link: "/ja/reference/std/nondet" },
        { text: "std::testing", link: "/ja/reference/std/testing" },
        { text: "std::time", link: "/ja/reference/std/time" },
      ],
    },
  ],
};
