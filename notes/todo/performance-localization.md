...
1. `scripts/performance-gate.sh`
2. compiled-unit cache Phase 1: manifest + syntax surface
3. compiled-unit cache Phase 2: namespace surface
4. generalize restart summary metrics
...
最初の実装タスクは、`scripts/performance-gate.sh` を作ること。
