...
| ✅⑧ | [choice-residual-overremoved](choice-residual-overremoved.md) | `choice_preserves_parse_residual_on_callback_and_result_effects` | — | **済**（fixture indentation 修正・残差共有 assertion に整理）|
