...
These are explicitly outside this product closure until their own
acceptance/recovery/product gates are approved:
...
The final Yulang2-compatibility closure must construct the deferred gates
separately rather than treating their absence as product completion.
