...
| pattern and structured delimiters | Pattern entries, delimited sequences, RecordPattern Item/Separator structured recovery | partial: the bounded item and separator structured Invalid rows are mapped; every other Pattern row remains open |
