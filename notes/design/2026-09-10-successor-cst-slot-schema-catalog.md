...
| proof and status | Governing slice above; enclosing alternation context and direct sequence publisher: `crates/yu-syntax/src/rule/mod.rs:334–375, 412–447, 864–878`. Direct Rowan proof: the terminal RuleBody `{;💥}` portion of `dedicated_rule_slots_are_directly_readable_from_the_rowan_tree`, `crates/yu-syntax/src/tests/rule_literal_recovery.rs:803–924`, proving the complete frame, two direct UTF-8 Error leaves, one maximal `1..6` group, native close, no Missing/Invalid and CST-only singleton RuleItem projection. Independent post-write delta audit was clean. Status: catalog-audited evidence-complete Draft for this terminal Body witness only; retry, parenthesized/interpolation callers, separator/newline/fence, nested grammar and ExpressionList remain open. |
