...
| `notes/design/2026-08-30-declaration-companion-with-addendum.md` | Authoritative | Shared declaration-owned `with:` grammar/CST/AST/recovery for Struct/Type/Enum/Error/Act | user-approved 2026-08-30 after independent compiler/spec/performance review | DC-G/J/T/R; owner matrix; Gates 1–8 complete, Gate 9 next |
