...
| `notes/design/2026-08-30-declaration-companion-with-addendum.md` | Authoritative | Shared declaration-owned `with:` grammar/CST/AST/recovery for Struct/Type/Enum/Error/Act | user-approved 2026-08-30 after independent compiler/spec/performance review | DC-G/J/T/R; owner matrix; Gates 1–2 complete, Gate 3 next |
...
| `notes/design/2026-08-31-declaration-companion-gate3-nud-sink-amendment.md` | Authoritative | Gate 3 generic speculative NUD candidate ErrorSink transaction correction | user-approved option 1 on 2026-08-31 | Exactly one checkpoint/rollback pair in `expression_nud_candidate_input`; bounded focused/package verification |
