# Historical task state before the accepted-input recovery authority change

Archived from `tasks/current.md` on 2026-09-08 without deleting the recorded
history. The active task is now `tasks/current.md`; this file is not a current
work queue. In particular, legacy-malformed parity prerequisites below are
superseded within the scope of
`notes/design/2026-09-08-successor-recovery-authority-amendment.md`.

The historical heading and contents follow unchanged.
