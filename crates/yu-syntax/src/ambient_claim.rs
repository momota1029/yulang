...
pub(crate) struct AmbientClaimContext<'frame> {
    pub(crate) view: Option<AmbientClaimView<'frame>>,
    #[cfg(test)]
...
impl<'frame> AmbientClaimContext<'frame> {
    ...
    #[inline]
    pub(crate) fn if_outer_tail(self) -> Self {
        #[cfg(test)]
    ...
    #[cfg(test)]
    pub(crate) fn assert_shape(self, baseline: Option<usize>, frames: &[usize]) {
    ...
    #[cfg(test)]
    pub(crate) fn with_proof(mut self, proof: fn(ProofSite, Option<AmbientClaimView<'_>>)) -> Self {
        self.proof = Some(proof);
        self
    }

    #[cfg(test)]
    pub(crate) fn observe(self, site: ProofSite) {
...
#[derive(Clone, Copy)]
pub(crate) struct AmbientClaimView<'frame> {
    statement_baseline: Option<usize>,
    companions: Option<&'frame AmbientIfCompanion<'frame>>,
}

pub(crate) struct AmbientIfCompanion<'frame> {
    #[allow(
        dead_code,
...
pub(crate) struct AmbientPositionEvidence<'word> {
    pub(crate) has_physical_newline: bool,
    pub(crate) following_line_indent: usize,
    pub(crate) following_word: Option<&'word str>,
}

impl<'frame> AmbientClaimView<'frame> {
    pub(crate) fn root_statement(baseline: usize) -> Self {
        Self {
    ...
    pub(crate) fn statement(self, baseline: usize) -> Self {
        Self {
            statement_baseline: Some(baseline),
            ..self
        }
    ...
    pub(crate) fn if_companion(self, baseline: usize) -> AmbientIfCompanion<'frame> {
        AmbientIfCompanion {
    ...
    pub(crate) fn claims(self, evidence: AmbientPositionEvidence<'_>) -> bool {
