...
fn run_required<'source>(
    ...
    let (mut primary, next_origin, next_line) = crate::rewrite::type_expr::type_nud_item_normalized(
    ...
    let (exit, found) = crate::rewrite::type_expr::required_type_expr_with_caller_stops_and_outer_boundary_normalized_with_ambient(
        In::new(&mut input, &mut recover, &mut output), primary, role, 0,
        crate::rewrite::operator::STOP_WITH, crate::rewrite::type_expr::TypeOuterBoundary::WITH,
