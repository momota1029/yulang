...
fn parse<'s>(
    ...
    let exit = crate::rewrite::delimited::delimited_items_normalized(
        In::new(&mut input, &mut recover, &mut output),
        match form {
            Form::Group => crate::rewrite::delimited::DelimitedOwner::Parenthesized,
            Form::Call => crate::rewrite::delimited::DelimitedOwner::Call,
            Form::Index => crate::rewrite::delimited::DelimitedOwner::Index,
            Form::Tuple => crate::rewrite::delimited::DelimitedOwner::ProjectionTuple,
            Form::Record => crate::rewrite::delimited::DelimitedOwner::ProjectionRecord,
        },
        0,
        0,
