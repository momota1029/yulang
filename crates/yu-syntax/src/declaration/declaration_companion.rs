...
pub(crate) fn declaration_companion_normalized(
    mut i: SyntaxIn,
...
fn introducer_boundary(mut i: SyntaxIn, item: &Item, baseline: usize, caller_stops: Stops) -> bool {
...
#[cfg(test)]
#[allow(clippy::too_many_arguments)]
pub(crate) fn declaration_companion_witness(
    mut i: SyntaxIn,
    baseline: usize,
    caller_stops: Stops,
    item_origin: usize,
    ...
    use crate::lexical::lexer::{contextual_word_suffix_follower, scan_expression_payload};
