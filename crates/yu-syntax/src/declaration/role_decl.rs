...
#[cfg(test)]
pub(crate) fn role_declaration_witness(
    mut i: SyntaxIn,
    baseline: usize,
    stops: Stops,
...
#[cfg(test)]
pub(crate) fn role_declaration_selected_normalized(
    i: SyntaxIn,
    item: &Item,
    baseline: usize,
    item_origin: usize,
...
pub(crate) fn role_declaration_selected_lexical(
    source: &str,
    item: &Item,
    baseline: usize,
    item_origin: usize,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn role_declaration_normalized(
    mut i: SyntaxIn,
    intro: Item,
    baseline: usize,
    stops: Stops,
