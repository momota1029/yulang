...
fn expected_boundary_item(
    ...
    let crate::lexical::yumark::FenceLineDecision::Boundary(pending) =
        crate::lexical::yumark::judge_fence_line(suffix, coordinate, fence)
    else {
    ...
    let boundary = Item::plain(
        ...
        Payload::Boundary(PendingBoundary::new(
            ...
            Boundary::Stop(StopKind::YumarkFence(Box::new(
                crate::lexical::yumark::YumarkFenceTransition {
                    line: 70,
                    expected_depth: 2,
                    expected_base: 0,
                    indentation: 70..70,
