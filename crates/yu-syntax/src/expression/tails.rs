...
use crate::{
    ...
    lexical::{
        ...
        stops::{STOP_COMMA, STOP_LINE_BREAK, Stops},
        trivia::lone_colon_after_fenced_trivia,
...
fn inline_colon_boundary(i: SyntaxIn, item: &Item, baseline: usize, stops: Stops) -> bool {
