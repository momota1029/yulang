...
use crate::parser::{
    ...
    output::emit::{emit_identifier_core, emit_integer_core, emit_operator_use},
...
#[cfg(test)]
pub(in crate::parser) fn expr(i: ParserIn) -> Option<TailExit> {
    expr_normalized(
        i,
        None,
        0,
...
#[cfg(test)]
pub(in crate::parser) fn expr_normalized(
    mut i: ParserIn,
...
pub(in crate::parser) fn expr_from_nud_normalized(
    mut i: ParserIn,
    nud: Item,
    threshold: Option<&BindingPower>,
    baseline: usize,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn scan_tail_after_accept_normalized(
    mut i: ParserIn,
    threshold: Option<&BindingPower>,
    baseline: usize,
    stops: Stops,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn continue_normalized_tail(
    i: ParserIn,
    threshold: Option<&BindingPower>,
    baseline: usize,
    stops: Stops,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn tail_normalized(
    mut i: ParserIn,
    item: Item,
    threshold: Option<&BindingPower>,
    baseline: usize,
...
pub(in crate::parser) fn chain_continuation(leading: LeadingView<'_>, baseline: usize) -> bool {
    indentation_after_newline(leading).is_none_or(|indentation| indentation > baseline)
}

pub(in crate::parser) fn is_led_operator(item: &Item) -> bool {
    matches!(
        operator_use(item),
...
pub(in crate::parser) fn is_nud_item(item: &Item) -> bool {
