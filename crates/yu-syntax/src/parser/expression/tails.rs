...
use crate::parser::{
    ...
    expression::{
        chain_continuation, continue_normalized_tail,
        delimited::{DelimitedOwner, delimited_items_normalized},
        expr_from_nud_normalized, is_led_operator, is_nud_item, scan_tail_after_accept_normalized,
        tail_normalized,
    },
...
pub(in crate::parser) fn colon_tail_normalized(
    mut i: ParserIn,
    mut colon: Item,
    baseline: usize,
    stops: Stops,
...
fn inline_colon_argument_normalized(
    ...
    let exit = expr_from_nud_normalized(
        ...
        fence,
        ambient,
        sequence.or(Some(crate::parser::context::sequence::SequenceOwner::Colon)),
    );
...
fn inline_colon_boundary(i: ParserIn, item: &Item, baseline: usize, stops: Stops) -> bool {
...
fn emit_inline_leading(i: &mut ParserIn, item: &mut Item) {
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn with_tail_normalized(
    mut i: ParserIn,
    mut keyword: Item,
    baseline: usize,
    stops: Stops,
...
fn with_inline_boundary(i: ParserIn, item: &Item, baseline: usize, stops: Stops) -> bool {
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn call_tail_normalized(
    mut i: ParserIn,
    open: Item,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn index_tail_normalized(
    mut i: ParserIn,
    open: Item,
    threshold: Option<&BindingPower>,
    baseline: usize,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn dot_tail_normalized(
    mut i: ParserIn,
    dot: Item,
    threshold: Option<&BindingPower>,
    baseline: usize,
    ...
    let (next, item_origin, line_entry) = crate::parser::input::expression::expression_item(
        i.rb(),
        OperatorSite::Led,
        item_origin,
        line_entry,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn path_tail_normalized(
    mut i: ParserIn,
    separator: Item,
    threshold: Option<&BindingPower>,
    baseline: usize,
