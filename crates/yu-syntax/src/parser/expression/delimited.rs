...
#[derive(Clone, Copy)]
pub(in crate::parser) enum DelimitedOwner {
    Parenthesized,
    Call,
    Index,
    ProjectionTuple,
...
pub(in crate::parser) fn parenthesized_nud_normalized(
    mut i: ParserIn,
    open: Item,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn delimited_items_normalized(
    mut i: ParserIn,
    ...
    let sequence = Some(match owner {
        DelimitedOwner::Parenthesized => {
            crate::parser::context::sequence::SequenceOwner::Parenthesized
        }
        DelimitedOwner::Call => crate::parser::context::sequence::SequenceOwner::Call,
        DelimitedOwner::Index => crate::parser::context::sequence::SequenceOwner::Index,
        DelimitedOwner::ProjectionTuple => {
            crate::parser::context::sequence::SequenceOwner::ProjectionTuple
        }
        DelimitedOwner::ProjectionRecord => {
            crate::parser::context::sequence::SequenceOwner::ProjectionRecord
        }
    });
