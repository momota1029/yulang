...
fn emit_rule_atom(i: &mut ParserIn, item: Item) {
...
fn emit_separator(i: &mut ParserIn, item: Item) {
...
fn emit_unexpected(i: ParserIn, item: Item, origin: usize, role: LiteralRole) {
...
pub(super) fn emit_rule_missing(i: ParserIn, role: LiteralRole, at: usize) {
