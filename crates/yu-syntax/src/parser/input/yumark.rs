...
use crate::parser::input::item::{BorrowedTarget, Boundary, PendingBoundary, StopKind};

#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::parser) struct FenceOpener {
    pub(in crate::parser) line: usize,
    pub(in crate::parser) marker: Range<usize>,
    pub(in crate::parser) marker_width: usize,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::parser) enum FencePrefixPolicy {
    #[allow(
        dead_code,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::parser) struct FenceBoundary {
    pub(in crate::parser) opener: FenceOpener,
    pub(in crate::parser) prefix_policy: FencePrefixPolicy,
    pub(in crate::parser) close_column: usize,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::parser) struct QuotePrefixFacts {
    pub(in crate::parser) indentation: Range<usize>,
    pub(in crate::parser) marker: Range<usize>,
    pub(in crate::parser) extent: Range<usize>,
    pub(in crate::parser) depth: usize,
    pub(in crate::parser) marker_len: usize,
    pub(in crate::parser) marker_end: usize,
    pub(in crate::parser) explicit: bool,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::parser) struct FenceCloseFacts {
    pub(in crate::parser) line: usize,
    pub(in crate::parser) inspected: Range<usize>,
    pub(in crate::parser) prefix: Option<QuotePrefixFacts>,
    pub(in crate::parser) indentation: Range<usize>,
    pub(in crate::parser) indentation_column: usize,
    pub(in crate::parser) marker: Range<usize>,
    pub(in crate::parser) marker_width: usize,
    pub(in crate::parser) horizontal_suffix: Range<usize>,
    pub(in crate::parser) newline: Option<Range<usize>>,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::parser) enum QuoteTransitionKind {
    Reduced,
    Greater,
    NonPrefix,
    Explicit,
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::parser) struct YumarkFenceTransition {
    pub(in crate::parser) line: usize,
    pub(in crate::parser) expected_depth: usize,
    pub(in crate::parser) expected_base: usize,
    pub(in crate::parser) indentation: Range<usize>,
    pub(in crate::parser) observed: Option<QuotePrefixFacts>,
    pub(in crate::parser) kind: QuoteTransitionKind,
    pub(in crate::parser) inspected: Range<usize>,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::parser) struct AcceptedQuotePrefix {
    pub(in crate::parser) facts: QuotePrefixFacts,
    /// First logical body byte; it can precede the full observed extent end.
    pub(in crate::parser) content: usize,
}

#[derive(Clone, Debug, Eq, PartialEq)]
pub(in crate::parser) enum FenceLineDecision {
...
#[cfg(test)]
pub(in crate::parser) fn is_yulang_fence_info(info: &str) -> bool {
...
pub(in crate::parser) fn judge_fence_line(
    source: &str,
    line: usize,
