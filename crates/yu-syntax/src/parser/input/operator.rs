...
pub(in crate::parser) const STOP_COMMA: Stops = 1 << 0;
pub(in crate::parser) const STOP_SEMICOLON: Stops = 1 << 1;
const STOP_RPAREN: Stops = 1 << 2;
const STOP_RBRACKET: Stops = 1 << 3;
const STOP_RBRACE: Stops = 1 << 4;
pub(in crate::parser) const STOP_CLOSES: Stops = STOP_RPAREN | STOP_RBRACKET | STOP_RBRACE;
pub(in crate::parser) const STOP_RECORD_SPREAD: Stops = 1 << 5;
pub(in crate::parser) const STOP_RECORD_SPREAD_AFTER_OPERATOR: Stops = 1 << 6;
pub(in crate::parser) const STOP_COLON: Stops = 1 << 7;
pub(in crate::parser) const STOP_LBRACE: Stops = 1 << 8;
pub(in crate::parser) const STOP_ELSIF: Stops = 1 << 9;
pub(in crate::parser) const STOP_ELSE: Stops = 1 << 10;
pub(in crate::parser) const STOP_ARROW: Stops = 1 << 11;
pub(in crate::parser) const STOP_LINE_BREAK: Stops = 1 << 12;
pub(in crate::parser) const STOP_WITH: Stops = 1 << 13;
pub(in crate::parser) const STOP_IN: Stops = 1 << 14;

pub(in crate::parser) fn stops_for(close: crate::parser::input::item::TokenKind) -> Stops {
    let close = match close {
        crate::parser::input::item::TokenKind::RParen => STOP_RPAREN,
        crate::parser::input::item::TokenKind::RBracket => STOP_RBRACKET,
        crate::parser::input::item::TokenKind::RBrace => STOP_RBRACE,
...
#[cfg(test)]
pub(in crate::parser) fn scan_operator(
    i: LexIn,
    site: OperatorSite,
...
pub(in crate::parser) fn scan_operator_fenced(
    mut i: LexIn,
    site: OperatorSite,
    has_leading_trivia: bool,
    baseline: usize,
...
pub(in crate::parser) fn scan_dangling_operator_fenced(
    mut i: LexIn,
    site: OperatorSite,
    baseline: usize,
    stops: Stops,
...
fn active_stop(source: &str, stops: Stops) -> bool {
    match source.chars().next() {
        ...
        Some('-') => {
            stops & STOP_ARROW != 0 && crate::parser::input::lexer::is_exact_arm_arrow(source)
        }
        _ => false,
    }
}

pub(in crate::parser) fn active_stop_item(
    kind: crate::parser::input::item::TokenKind,
    stops: Stops,
) -> bool {
    match kind {
        crate::parser::input::item::TokenKind::Comma => stops & STOP_COMMA != 0,
        crate::parser::input::item::TokenKind::Semicolon => stops & STOP_SEMICOLON != 0,
        crate::parser::input::item::TokenKind::RParen => stops & STOP_RPAREN != 0,
        crate::parser::input::item::TokenKind::RBracket => stops & STOP_RBRACKET != 0,
        crate::parser::input::item::TokenKind::RBrace => stops & STOP_RBRACE != 0,
        crate::parser::input::item::TokenKind::Colon => stops & STOP_COLON != 0,
        crate::parser::input::item::TokenKind::LBrace => stops & STOP_LBRACE != 0,
        crate::parser::input::item::TokenKind::Arrow => stops & STOP_ARROW != 0,
        _ => false,
    }
}

pub(in crate::parser) fn lone_colon_after_fenced_trivia(
    source: &str,
    source_origin: usize,
...
pub(in crate::parser) fn newline_indentation_after_fenced_trivia(
    source: &str,
    source_origin: usize,
    line_entry: LineEntry,
    fence: Option<&FenceBoundary>,
...
pub(in crate::parser) enum TriviaObservation<'source> {
    Visible(VisibleTrivia<'source>),
    Boundary,
}

pub(in crate::parser) struct VisibleTrivia<'source> {
    pub(in crate::parser) source: &'source str,
    pub(in crate::parser) present: bool,
    pub(in crate::parser) indentation: Option<usize>,
}

pub(in crate::parser) struct TriviaObservationWithNewline<'source> {
    pub(in crate::parser) observation: TriviaObservation<'source>,
    pub(in crate::parser) saw_physical_newline: bool,
}
...
pub(in crate::parser) fn observe_fenced_trivia<'source>(
    source: &'source str,
    source_origin: usize,
    line_entry: LineEntry,
    fence: Option<&FenceBoundary>,
...
pub(in crate::parser) fn observe_fenced_trivia_with_newline<'source>(
