...
use super::{
    ...
    driver::{NormalizedExit, complete, handoff, indentation_after_newline, token_kind},
    emit::{emit_recovery_error_run, emit_recovery_missing},
...
#[allow(clippy::too_many_arguments)]
pub(super) fn use_declaration_header_normalized(
    i: ParserIn,
    intro: Item,
    baseline: usize,
    stops: Stops,
...
pub(super) fn next_use_item_lex(
    mut i: LexIn,
    item_origin: &mut usize,
    line_entry: &mut LineEntry,
    fence: Option<&FenceBoundary>,
