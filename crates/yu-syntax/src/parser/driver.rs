...
pub(super) fn suffix_marker(mut i: ParserIn) -> (usize, usize) {
...
pub(super) fn is_active_stop(i: ParserIn, item: &Item, stops: Stops) -> bool {
    i.map(
...
pub(super) fn is_contextual_word(mut i: ParserIn, item: &Item, word: &str) -> bool {
