...
fn emit_forall_separator_binder(mut i: ParserIn, mut separator: Item, item_origin: usize) {
    i.state.start_node(SyntaxKind::ForallTypeBinder.into());
...
fn type_forall_binder(mut i: ParserIn, mut binder: Item, item_origin: usize) {
    i.state.start_node(SyntaxKind::ForallTypeBinder.into());
...
fn emit_forall_missing(i: &mut ParserIn, role: TypeRole, item: &Item, item_origin: usize) {
