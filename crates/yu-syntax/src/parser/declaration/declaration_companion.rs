...
#[cfg(test)]
use crate::parser::input::current_item::CurrentItem;
...
use crate::parser::{
    ...
    input::{
        ...
        observation::{
            ...
            is_active_stop, is_close, is_contextual_word, is_separator, token_kind,
        },
...
pub(in crate::parser) fn declaration_companion_normalized(
    mut i: ParserIn,
...
fn introducer_boundary(mut i: ParserIn, item: &Item, baseline: usize, caller_stops: Stops) -> bool {
...
fn emit_separator_leading(i: &mut ParserIn, item: &mut Item) {
    i.state
        .start_node(SyntaxKind::BlockStatementSeparator.into());
    item.emit_all_remaining_leading(&mut *i.state);
    i.state.finish_node();
...
fn emit_companion_missing(i: &mut ParserIn, item: &Item, origin: usize, role: GrammarRole) {
...
fn emit_missing_statement(i: &mut ParserIn, item: &Item, origin: usize, role: CompanionRole) {
    i.state.start_node(SyntaxKind::Statement.into());
...
#[cfg(test)]
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn declaration_companion_witness(
    mut i: ParserIn,
    baseline: usize,
    caller_stops: Stops,
    item_origin: usize,
    ...
    use crate::parser::input::lexer::{contextual_word_suffix_follower, scan_expression_payload};
