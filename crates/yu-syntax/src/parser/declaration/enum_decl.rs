...
#[cfg(test)]
pub(in crate::parser) fn enum_declaration_witness(
    mut i: ParserIn,
    baseline: usize,
    stops: Stops,
...
#[cfg(test)]
pub(in crate::parser) fn enum_declaration_selected_normalized(
    i: ParserIn,
    item: &Item,
    baseline: usize,
    item_origin: usize,
...
pub(in crate::parser) fn enum_declaration_selected_lexical(
    source: &str,
    item: &Item,
    baseline: usize,
    item_origin: usize,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn enum_declaration_normalized(
    mut i: ParserIn,
    intro: Item,
    baseline: usize,
    stops: Stops,
...
fn parse_variant_body_normalized(
    ...
    let exit = declaration_variant_sequence_normalized(
        i.rb(),
        crate::parser::declaration::declaration_variant::VariantOwner::Enum,
        form,
        introducer,
        yield_with,
        baseline,
