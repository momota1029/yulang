...
#[cfg(test)]
pub(in crate::parser) fn cast_declaration_witness(
    mut i: ParserIn,
    baseline: usize,
    stops: Stops,
...
#[cfg(test)]
pub(in crate::parser) fn cast_declaration_selected_normalized(
    i: ParserIn,
    item: &Item,
    baseline: usize,
    item_origin: usize,
...
pub(in crate::parser) fn cast_declaration_selected_lexical(
    source: &str,
    item: &Item,
    baseline: usize,
    item_origin: usize,
...
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn cast_declaration_normalized(
    mut i: ParserIn,
    intro: Item,
    baseline: usize,
    stops: Stops,
...
fn cast_inline_body_boundary(mut i: ParserIn, item: &Item, baseline: usize, stops: Stops) -> bool {
...
fn slot_outer_boundary(mut i: ParserIn, item: &Item, baseline: usize, stops: Stops) -> bool {
    item.payload_view().is_boundary()
        || item.payload_view().is_eof()
