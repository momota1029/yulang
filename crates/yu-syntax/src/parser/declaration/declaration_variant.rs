...
pub(in crate::parser) enum VariantOwner {
    Enum,
    Error,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::parser) enum VariantSequenceForm {
    Braced,
    ColonIndented,
    EqualsInline,
    EqualsIndented,
...
pub(in crate::parser) fn declaration_variant_sequence_normalized(
    mut i: ParserIn,
    owner: VariantOwner,
...
fn emit_missing_variant(i: &mut ParserIn, owner: VariantOwner, item: &Item, origin: usize) {
...
#[cfg(test)]
pub(in crate::parser) fn declaration_variant_sequence_witness(
    i: ParserIn,
    form: VariantSequenceForm,
    baseline: usize,
    item_origin: usize,
...
#[cfg(test)]
#[allow(clippy::too_many_arguments)]
pub(in crate::parser) fn declaration_variant_owner_witness(
    mut i: ParserIn,
    owner: VariantOwner,
    form: VariantSequenceForm,
    yield_with: bool,
