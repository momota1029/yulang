...
fn safe_point(item: &Item, role: OperatorHeaderRole) -> bool {
    ...
    match role {
        ...
        OperatorHeaderRole::LeftBindingPower | OperatorHeaderRole::RightBindingPower => {
            text == "=" || (!power_shaped(text) && crate::parser::expression::is_nud_item(item))
        }
        OperatorHeaderRole::DefinitionIntroducer => crate::parser::expression::is_nud_item(item),
...
pub(in crate::parser) fn next_item(
    i: LexIn,
    origin: usize,
    line: LineEntry,
...
fn next_slot_item(
    ...
    let CurrentItem {
        ...
        |mut lex, gap, payload_origin, _, _| {
            ...
            crate::parser::input::expression::scan_expression_payload_with_literals(
                lex,
                OperatorSite::Nud,
                gap,
                payload_origin,
...
pub(in crate::parser) fn operator_header_normalized(
    mut i: ParserIn,
    mut item: Item,
    mut origin: usize,
    mut line: LineEntry,
