...
use crate::parser::{
    ...
    input::{
        ...
        observation::{indentation_after_newline, is_active_stop_lex, token_kind},
...
pub(in crate::parser) fn derives_clause_normalized(
    mut i: ParserIn,
    keyword: Item,
    baseline: usize,
    caller_stops: Stops,
...
pub(in crate::parser) fn is_word(item: &Item, word: &str) -> bool {
