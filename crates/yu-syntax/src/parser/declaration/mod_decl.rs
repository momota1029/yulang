...
pub(in crate::parser) fn mod_declaration_selected_lexical(
    source: &str,
    item: &Item,
    baseline: usize,
    item_origin: usize,
...
pub(in crate::parser) fn mod_declaration_normalized(
    mut i: ParserIn,
    intro: Item,
    baseline: usize,
    stops: Stops,
...
fn emit_name(i: &mut ParserIn, item: Item, is_test: bool) {
    if is_test {
...
fn mod_missing(i: &mut ParserIn, item: &Item, origin: usize, role: ModRole, colon_only: bool) {
...
fn name_boundary(mut i: ParserIn, item: &Item, baseline: usize, stops: Stops) -> bool {
...
fn mod_boundary(mut i: ParserIn, item: &Item, baseline: usize, stops: Stops) -> bool {
