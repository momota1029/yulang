use crate::parser::declaration::operator_header::{next_item, operator_header_normalized};
...
fn quoted_fence_keeps_pending_crlf_and_anchors_at_abstract_coordinate() {
    use crate::parser::input::yumark::{FenceBoundary, FenceOpener, FencePrefixPolicy};
    use crate::session::{OperatorHeaderRole as R, RecoveryKind as K};
