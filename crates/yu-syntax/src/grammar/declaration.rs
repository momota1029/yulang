        ...
        fn parse_direct(
            ...
            (
                match range {
                    ...
                    Recovered::Incomplete => panic!("Impl declaration range is complete"),
                },
                remainder,
                local.line(),
                records,
