...
pub struct RuntimeEvidenceRunStats {
    ...
    pub static_route_sites_total: usize,
    pub static_route_static_handler: usize,
    pub static_route_static_tail_resumptive: usize,
    pub static_route_static_abortive: usize,
    pub static_route_static_other_arm: usize,
    pub static_route_dynamic_open_row: usize,
    pub static_route_dynamic_multiple_candidates: usize,
    pub static_route_dynamic_hygiene_barrier: usize,
    pub static_route_dynamic_provider_env: usize,
    ...
    pub static_route_runtime_hits_dynamic_multiple_candidates: usize,
    pub static_route_runtime_hits_dynamic_hygiene_barrier: usize,
    pub static_route_runtime_hits_dynamic_provider_env: usize,
    pub static_route_runtime_hits_dynamic_delayed_boundary: usize,
    pub static_route_runtime_hits_dynamic_host_escape: usize,
    pub static_route_runtime_hits_dynamic_unclassified: usize,
    ...
    pub max_continuation_then_frames: usize,
    pub max_continuation_state_frames: usize,
    pub max_continuation_force_frames: usize,
    pub max_continuation_apply_frames: usize,
    pub max_continuation_adapter_frames: usize,
    pub max_continuation_case_frames: usize,
    pub max_continuation_catch_frames: usize,
    pub max_continuation_scope_frames: usize,
    pub max_continuation_marker_frames: usize,
    pub max_continuation_provider_env_frames: usize,
    pub max_continuation_aggregate_frames: usize,
    pub max_continuation_select_frames: usize,
    pub max_continuation_block_frames: usize,
    pub max_continuation_ref_set_frames: usize,
    pub max_active_frames_len: usize,
    pub max_active_handler_frames_len: usize,
    pub max_active_add_ids_len: usize,
    pub max_active_marker_plans_len: usize,
    pub max_active_provider_envs_len: usize,
    pub max_active_provider_handlers_len: usize,
    pub max_active_state_handler_frames_len: usize,
    pub max_host_scheduler_branches: usize,
    pub max_host_scheduler_one_shot_tokens: usize,
    pub max_host_scheduler_multi_shot_parents: usize,
    pub max_host_scheduler_multi_shot_tokens: usize,
    pub max_suspended_host_continuations: usize,
    ...
    pub tail_invariant_base_would_loop: usize,
    pub tail_invariant_base_rejected_identity_mismatch: usize,
    pub tail_invariant_base_rejected_continuation_captured: usize,
    pub tail_invariant_base_rejected_carried_guard: usize,
    pub tail_invariant_base_rejected_adapter_env: usize,
    pub tail_invariant_base_rejected_other: usize,
    pub tail_invariant_base_rejected_identity_mismatch_frames: usize,
    pub tail_invariant_base_rejected_identity_mismatch_handler_frames: usize,
    pub tail_invariant_base_rejected_identity_mismatch_add_ids: usize,
    pub tail_invariant_base_rejected_identity_mismatch_marker_plans: usize,
    pub tail_invariant_base_rejected_identity_mismatch_provider_envs: usize,
    pub tail_invariant_base_rejected_identity_mismatch_provider_handlers: usize,
    pub tail_invariant_base_rejected_identity_mismatch_state_handler_frames: usize,
    pub tail_invariant_base_rejected_identity_mismatch_host_branch: usize,
    pub tail_invariant_base_rejected_other_callee_not_closure: usize,
    pub tail_invariant_base_rejected_other_no_active_marker_scope: usize,
    pub tail_invariant_base_rejected_other_unsupported_marker_source: usize,
    pub tail_invariant_base_rejected_other_handler_path: usize,
    pub tail_invariant_base_rejected_other_no_active_add_id: usize,
    pub tail_invariant_base_rejected_other_no_candidate_marker_scope: usize,
    pub tail_invariant_base_at_tail_would_loop: usize,
    pub tail_invariant_base_at_tail_rejected_identity_mismatch: usize,
    pub tail_invariant_base_at_tail_rejected_continuation_captured: usize,
    pub tail_invariant_base_at_tail_rejected_carried_guard: usize,
    pub tail_invariant_base_at_tail_rejected_adapter_env: usize,
    pub tail_invariant_base_at_tail_rejected_other: usize,
    pub tail_invariant_base_at_resume_would_loop: usize,
    pub tail_invariant_base_at_resume_rejected_identity_mismatch: usize,
    pub tail_invariant_base_at_resume_rejected_continuation_captured: usize,
    pub tail_invariant_base_at_resume_rejected_carried_guard: usize,
    pub tail_invariant_base_at_resume_rejected_adapter_env: usize,
    pub tail_invariant_base_at_resume_rejected_other: usize,
    pub tail_invariant_base_at_resume_plain_would_loop: usize,
    pub tail_invariant_base_at_resume_plain_rejected_identity_mismatch: usize,
    pub tail_invariant_base_at_resume_plain_rejected_other: usize,
    pub tail_invariant_base_at_resume_recursive_would_loop: usize,
    pub tail_invariant_base_at_resume_recursive_rejected_identity_mismatch: usize,
    pub tail_invariant_base_at_resume_recursive_rejected_other: usize,
    ...
    pub marked_force_reentry_same_identity: usize,
    ...
    pub resume_plan_sidecar_exec_candidates: usize,
    pub resume_plan_sidecar_exec_ready: usize,
    pub resume_plan_sidecar_exec_hits: usize,
    pub resume_plan_sidecar_exec_fallbacks: usize,
    pub resume_plan_sidecar_exec_reject_root_marker_mismatch: usize,
    pub resume_plan_sidecar_exec_reject_provider_scope_mismatch: usize,
    pub resume_plan_sidecar_exec_reject_child_marker_scope: usize,
    pub resume_plan_sidecar_exec_reject_same_handler_boundary: usize,
    pub resume_plan_sidecar_exec_reject_ref_set_boundary: usize,
    pub resume_plan_sidecar_exec_reject_shape_mismatch: usize,
    pub resume_plan_sidecar_exec_root_marker_frames: usize,
    pub resume_plan_sidecar_exec_provider_frames: usize,
    pub resume_plan_sidecar_exec_child_marker_frames: usize,
    pub resume_plan_sidecar_exec_legacy_frame_avoid_estimate: usize,
