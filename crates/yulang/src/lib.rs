...
pub use source::{
    ...
    rename_entry_source_with_std_options, run_built_control_program, run_control_from_entry,
    run_control_from_entry_with_std, run_control_from_entry_with_std_options,
    run_control_from_source_text_with_embedded_std, run_mono_from_entry,
