...
pub use source::{
    ...
    SourceDiagnosticSeverity, SourceFileIdentity, SourceHover, SourceHoverDocumentationDraft,
    SourceLocation, SourceRange, SourceRename, SourceTestBinding, SourceTestModule, SourceTextEdit,
