...
fn format_neg_signature_build_error(error: &infer::lowering::NegSignatureBuildError) -> String {
    match error {
        infer::lowering::NegSignatureBuildError::ExpectedTypeExpr { kind } => {
            format!(
                "expected type expression in signature, found {}",
                format_syntax_kind(*kind)
            )
        }
...
fn format_syntax_kind(kind: parser::lex::SyntaxKind) -> &'static str {
    use parser::lex::SyntaxKind;

    match kind {
        SyntaxKind::Space => "whitespace",
        SyntaxKind::LineComment => "line comment",
        SyntaxKind::BlockCommentStart => "block comment start",
        SyntaxKind::BlockCommentText => "block comment text",
        SyntaxKind::BlockCommentEnd => "block comment end",
        SyntaxKind::QuotePrefix => "quote prefix",
        SyntaxKind::DocComment => "doc comment",
        SyntaxKind::BlockComment => "block comment",
        SyntaxKind::LineDocPrefix => "line doc prefix",
        SyntaxKind::Trivia => "trivia",
        SyntaxKind::Ident => "identifier",
        SyntaxKind::Number => "number literal",
        SyntaxKind::StringStart => "string literal start",
        SyntaxKind::StringEnd => "string literal end",
        SyntaxKind::StringText => "string literal text",
        SyntaxKind::StringEscapeLead => "string escape",
        SyntaxKind::StringEscapeSimple => "simple string escape",
        SyntaxKind::StringEscapeUnicodeStart => "unicode escape start",
        SyntaxKind::StringEscapeUnicodeHex => "unicode escape digit",
        SyntaxKind::StringEscapeUnicodeEnd => "unicode escape end",
        SyntaxKind::StringInterpPercent => "string interpolation marker",
        SyntaxKind::StringInterpFormatText => "string interpolation format",
        SyntaxKind::StringInterpOpenBrace => "string interpolation opening brace",
        SyntaxKind::StringInterpCloseBrace => "string interpolation closing brace",
        SyntaxKind::Symbol => "symbol literal",
        SyntaxKind::SigilIdent => "sigil identifier",
        SyntaxKind::OpName => "operator name",
        SyntaxKind::Keyword => "keyword",
        SyntaxKind::Do => "`do` keyword",
        SyntaxKind::If => "`if` keyword",
        SyntaxKind::Else => "`else` keyword",
        SyntaxKind::Elsif => "`elsif` keyword",
        SyntaxKind::Case => "`case` keyword",
        SyntaxKind::Catch => "`catch` keyword",
        SyntaxKind::My => "`my` keyword",
        SyntaxKind::Our => "`our` keyword",
        SyntaxKind::Pub => "`pub` keyword",
        SyntaxKind::Use => "`use` keyword",
        SyntaxKind::Type => "`type` keyword",
        SyntaxKind::Struct => "`struct` keyword",
        SyntaxKind::Enum => "`enum` keyword",
        SyntaxKind::Role => "`role` keyword",
        SyntaxKind::Impl => "`impl` keyword",
        SyntaxKind::Act => "`act` keyword",
        SyntaxKind::Mod => "`mod` keyword",
        SyntaxKind::As => "`as` keyword",
        SyntaxKind::For => "`for` keyword",
        SyntaxKind::In => "`in` keyword",
        SyntaxKind::With => "`with` keyword",
        SyntaxKind::Where => "`where` keyword",
        SyntaxKind::Via => "`via` keyword",
        SyntaxKind::Mark => "`mark` keyword",
        SyntaxKind::ParenL => "opening parenthesis",
        SyntaxKind::ParenR => "closing parenthesis",
        SyntaxKind::BracketL => "opening bracket",
        SyntaxKind::BracketR => "closing bracket",
        SyntaxKind::BraceL => "opening brace",
        SyntaxKind::BraceR => "closing brace",
        SyntaxKind::Backslash => "backslash",
        SyntaxKind::Apostrophe => "apostrophe",
        SyntaxKind::Arrow => "arrow",
        SyntaxKind::ColonColon => "path separator",
        SyntaxKind::DotField => "field selector",
        SyntaxKind::Comma => "comma",
        SyntaxKind::Colon => "colon",
        SyntaxKind::Equal => "equals sign",
        SyntaxKind::Semicolon => "semicolon",
        SyntaxKind::Pipe => "pipe",
        SyntaxKind::Infix => "`infix` keyword",
        SyntaxKind::Prefix => "`prefix` keyword",
        SyntaxKind::Suffix => "`suffix` keyword",
        SyntaxKind::Nullfix => "`nullfix` keyword",
        SyntaxKind::Slash => "slash",
        SyntaxKind::Unknown => "unknown token",
        SyntaxKind::Rule => "`rule` keyword",
        SyntaxKind::Tilde => "tilde",
        SyntaxKind::RuleQuantStar => "rule `*` quantifier",
        SyntaxKind::RuleQuantStarLazy => "rule `*?` quantifier",
        SyntaxKind::RuleQuantPlus => "rule `+` quantifier",
        SyntaxKind::RuleQuantPlusLazy => "rule `+?` quantifier",
        SyntaxKind::RuleQuantOpt => "rule `?` quantifier",
        SyntaxKind::RuleLitStart => "rule literal start",
        SyntaxKind::RuleLitEnd => "rule literal end",
        SyntaxKind::RuleLitText => "rule literal text",
        SyntaxKind::RuleLitOpenBrace => "rule literal opening brace",
        SyntaxKind::RuleLitCloseBrace => "rule literal closing brace",
        SyntaxKind::RuleLitColon => "rule literal colon",
        SyntaxKind::MarkLitStart => "mark literal start",
        SyntaxKind::MarkLitEnd => "mark literal end",
        SyntaxKind::MarkLitText => "mark literal text",
        SyntaxKind::MarkHeadingSigil => "mark heading marker",
        SyntaxKind::MarkSectionCloseSigil => "mark section close marker",
        SyntaxKind::MarkBlankLine => "mark blank line",
        SyntaxKind::DotDot => "rest marker",
        SyntaxKind::Cast => "`cast` keyword",
        SyntaxKind::YmHashSigil => "yumark heading marker",
        SyntaxKind::YmHashDotSigil => "yumark explicit section marker",
        SyntaxKind::YmListDashSigil => "yumark bullet list marker",
        SyntaxKind::YmListNumSigil => "yumark numbered list marker",
        SyntaxKind::YmFenceSigil => "yumark code fence marker",
        SyntaxKind::YmChevronBlockSigil => "yumark block quote marker",
        SyntaxKind::YmChevronPrefixSigil => "yumark quote prefix",
        SyntaxKind::YmBlankLine => "yumark blank line",
        SyntaxKind::YmText => "yumark text",
        SyntaxKind::YmLBracket => "yumark opening bracket",
        SyntaxKind::YmRBracket => "yumark closing bracket",
        SyntaxKind::YmBang => "yumark exclamation mark",
        SyntaxKind::YmColon => "yumark colon",
        SyntaxKind::YmBackslash => "yumark backslash",
        SyntaxKind::YmIdent => "yumark identifier",
        SyntaxKind::YmSemi => "yumark semicolon",
        SyntaxKind::YmNewline => "yumark newline",
        SyntaxKind::YmPrefix => "yumark prefix",
        SyntaxKind::YmStarSigil => "yumark emphasis marker",
        SyntaxKind::YmStrongSigil => "yumark strong marker",
        SyntaxKind::YmDocBlockSigil => "yumark document block marker",
        SyntaxKind::Error => "parser error",
        SyntaxKind::Lazy => "`lazy` keyword",
        SyntaxKind::YadaYada => "yada-yada marker",
        SyntaxKind::Sub => "`sub` keyword",
        SyntaxKind::Dot => "dot",
        SyntaxKind::Derives => "`derives` keyword",
        SyntaxKind::InvalidToken => "invalid token",
        SyntaxKind::Expr => "expression",
        SyntaxKind::Pattern => "pattern",
        SyntaxKind::PatOr => "or-pattern",
        SyntaxKind::PatAs => "as-pattern",
        SyntaxKind::TypeAnn => "type annotation",
        SyntaxKind::TypeExpr => "type expression",
        SyntaxKind::TypeApply => "type application",
        SyntaxKind::TypeCall => "type call",
        SyntaxKind::TypeArrow => "function type",
        SyntaxKind::TypeForall => "forall type",
        SyntaxKind::ApplyML => "ml-style application",
        SyntaxKind::ApplyC => "call application",
        SyntaxKind::ApplyColon => "colon application",
        SyntaxKind::PrefixNode => "prefix expression",
        SyntaxKind::InfixNode => "infix expression",
        SyntaxKind::SuffixNode => "suffix expression",
        SyntaxKind::PathSep => "qualified path",
        SyntaxKind::Field => "field access",
        SyntaxKind::Index => "index expression",
        SyntaxKind::LambdaExpr => "lambda expression",
        SyntaxKind::IfExpr => "if expression",
        SyntaxKind::IfArm => "if arm",
        SyntaxKind::ElseArm => "else arm",
        SyntaxKind::Cond => "condition",
        SyntaxKind::CaseExpr => "case expression",
        SyntaxKind::CaseBlock => "case block",
        SyntaxKind::CaseArm => "case arm",
        SyntaxKind::CaseGuard => "case guard",
        SyntaxKind::CatchExpr => "catch expression",
        SyntaxKind::CatchBlock => "catch block",
        SyntaxKind::CatchArm => "catch arm",
        SyntaxKind::CatchGuard => "catch guard",
        SyntaxKind::Paren => "parenthesized expression",
        SyntaxKind::Bracket => "bracketed expression",
        SyntaxKind::BraceGroup => "brace group",
        SyntaxKind::IndentBlock => "indented block",
        SyntaxKind::Separator => "separator",
        SyntaxKind::StringLit => "string literal",
        SyntaxKind::StringInterp => "string interpolation",
        SyntaxKind::PatParenGroup => "parenthesized pattern",
        SyntaxKind::PatRecord => "record pattern",
        SyntaxKind::PatField => "record pattern field",
        SyntaxKind::TypeParenGroup => "parenthesized type annotation",
        SyntaxKind::TypeRecord => "record type annotation",
        SyntaxKind::TypeField => "type annotation field",
        SyntaxKind::TypeRow => "effect row",
        SyntaxKind::Binding => "binding",
        SyntaxKind::BindingHeader => "binding header",
        SyntaxKind::BindingBody => "binding body",
        SyntaxKind::ModDecl => "module declaration",
        SyntaxKind::UseDecl => "use declaration",
        SyntaxKind::ActDecl => "act declaration",
        SyntaxKind::TypeDecl => "type declaration",
        SyntaxKind::StructDecl => "struct declaration",
        SyntaxKind::EnumDecl => "enum declaration",
        SyntaxKind::RoleDecl => "role declaration",
        SyntaxKind::ImplDecl => "impl declaration",
        SyntaxKind::DerivesClause => "derives clause",
        SyntaxKind::WhereClause => "where clause",
        SyntaxKind::StructField => "struct field",
        SyntaxKind::EnumVariant => "enum variant",
        SyntaxKind::OpDef => "operator definition",
        SyntaxKind::OpDefHeader => "operator definition header",
        SyntaxKind::OpDefBody => "operator definition body",
        SyntaxKind::Root => "source root",
        SyntaxKind::WherePredicate => "where predicate",
        SyntaxKind::TypeVars => "type variables",
        SyntaxKind::TypePolyVariant => "polymorphic variant type",
        SyntaxKind::TypePolyVariantItem => "polymorphic variant type item",
        SyntaxKind::RuleExpr => "rule expression",
        SyntaxKind::RuleLit => "rule literal",
        SyntaxKind::RuleAlt => "rule alternative",
        SyntaxKind::RuleSeq => "rule sequence",
        SyntaxKind::RuleCapture => "rule capture",
        SyntaxKind::RuleParserRef => "rule parser reference",
        SyntaxKind::RuleLazyCapture => "lazy rule capture",
        SyntaxKind::RuleQuant => "rule quantifier",
        SyntaxKind::RuleLitInterp => "rule literal interpolation",
        SyntaxKind::MarkExpr => "mark expression",
        SyntaxKind::MarkInlineBody => "inline mark body",
        SyntaxKind::MarkHeredocBody => "multiline mark body",
        SyntaxKind::MarkDoc => "mark document",
        SyntaxKind::MarkParagraph => "mark paragraph",
        SyntaxKind::MarkText => "mark text",
        SyntaxKind::MarkHeading => "mark heading",
        SyntaxKind::MarkSectionClose => "mark section close",
        SyntaxKind::YmDoc => "yumark document",
        SyntaxKind::YmHeading => "yumark heading",
        SyntaxKind::YmImplicitSection => "yumark implicit section",
        SyntaxKind::YmExplicitSection => "yumark explicit section",
        SyntaxKind::YmSectionClose => "yumark section close",
        SyntaxKind::YmList => "yumark list",
        SyntaxKind::YmListItem => "yumark list item",
        SyntaxKind::YmListItemBody => "yumark list item body",
        SyntaxKind::YmCodeFence => "yumark code fence",
        SyntaxKind::YmCodeFenceInfo => "yumark code fence info",
        SyntaxKind::YmCodeFenceText => "yumark code fence text",
        SyntaxKind::YmQuoteBlock => "yumark quote block",
        SyntaxKind::YmParagraph => "yumark paragraph",
        SyntaxKind::YmInlineExpr => "yumark inline expression",
        SyntaxKind::YmLinkDest => "yumark link destination",
        SyntaxKind::YmApplyOp => "yumark application operator",
        SyntaxKind::YmApplyArgs => "yumark application arguments",
        SyntaxKind::YmInlineRef => "yumark inline reference",
        SyntaxKind::YmInlineRefArgs => "yumark inline reference arguments",
        SyntaxKind::YmCommand => "yumark command",
        SyntaxKind::YmCommandArgs => "yumark command arguments",
        SyntaxKind::YmCommandBody => "yumark command body",
        SyntaxKind::YmMy => "yumark binding",
        SyntaxKind::YmMyHead => "yumark binding head",
        SyntaxKind::YmMyBody => "yumark binding body",
        SyntaxKind::YmUse => "yumark use declaration",
        SyntaxKind::YmIfChain => "yumark if chain",
        SyntaxKind::YmIf => "yumark if branch",
        SyntaxKind::YmElsif => "yumark elsif branch",
        SyntaxKind::YmElse => "yumark else branch",
        SyntaxKind::YmIfCond => "yumark if condition",
        SyntaxKind::YmIfBody => "yumark if body",
        SyntaxKind::YmYulangArgs => "yumark yulang arguments",
        SyntaxKind::YmEmphasis => "yumark emphasis",
        SyntaxKind::YmStrong => "yumark strong text",
        SyntaxKind::YmCommandInlineBody => "yumark inline command body",
        SyntaxKind::DocCommentDecl => "doc comment declaration",
        SyntaxKind::CastDecl => "cast declaration",
        SyntaxKind::MethodLambdaExpr => "method lambda expression",
        SyntaxKind::RecursiveLambdaExpr => "recursive lambda expression",
        SyntaxKind::CaseLambdaExpr => "case lambda expression",
        SyntaxKind::CatchLambdaExpr => "catch lambda expression",
        SyntaxKind::PatSpread => "spread pattern",
        SyntaxKind::TypeEffectRow => "effect row type annotation",
        SyntaxKind::Assign => "assignment expression",
        SyntaxKind::WithBlock => "with block",
        SyntaxKind::PatList => "list pattern",
        SyntaxKind::PipeNode => "pipeline expression",
        SyntaxKind::ForStmt => "for statement",
        SyntaxKind::ForHeader => "for header",
        SyntaxKind::ForBody => "for body",
        SyntaxKind::ForLabel => "for label",
        SyntaxKind::ExprSpread => "spread expression",
        SyntaxKind::ErrorDecl => "error declaration",
        SyntaxKind::ImplDescription => "impl description",
        SyntaxKind::SubExpr => "sub expression",
        SyntaxKind::SubLambdaExpr => "sub lambda expression",
