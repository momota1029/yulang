...
pub use source::{
    ...
    StdInferSnapshotEffectOperation, StdInferSnapshotImport, StdInferSnapshotImportError,
    StdInferSnapshotImportMissing, StdInferSnapshotManifest, StdInferSnapshotMissingPath,
    ...
    StdInferSnapshotVisibility, StdSourceCacheKey, build_std_infer_snapshot,
    build_std_infer_snapshot_data, import_std_infer_snapshot_data, lower_entry_with_options,
