...
pub use source::{
    ...
    StdInferSnapshotDataError, StdInferSnapshotEffectOperation, StdInferSnapshotManifest,
    ...
    StdInferSnapshotOperatorFixity, StdInferSnapshotReexport, StdInferSnapshotSymbol,
    StdInferSnapshotVisibility, StdSourceCacheKey, build_std_infer_snapshot,
    build_std_infer_snapshot_data, lower_entry_with_options, lower_entry_with_options_profiled,
