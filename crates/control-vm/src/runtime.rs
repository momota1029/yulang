...
pub struct RuntimeStats {
    ...
    pub marker_frame_marker_entries: u64,
    ...
    pub active_add_id_path_candidates: u64,
    pub active_add_id_skipped_own_path: u64,
    pub active_add_id_skipped_foreign_path: u64,
    pub active_add_id_skipped_disabled_path: u64,
    pub active_add_id_skipped_entry_except: u64,
    pub active_add_id_skipped_carried_duplicate: u64,
    pub active_add_id_applied_direct: u64,
    pub active_add_id_applied_carried: u64,
