...
use poly::expr::{Def, DefId, Expr, Lit, Pat, PatId, RefId, Stmt, Vis};
use poly::types::{
...
impl<'a> ExprLowerer<'a> {
    ...
    fn lower_tail_node(
        ...
        match node.kind() {
            SyntaxKind::ApplyML | SyntaxKind::ApplyC => self.apply_arguments(acc, node),
