...
fn expected_characterization() -> Vec<ConstraintCharacterization> {
    ...
    vec![
        ConstraintCharacterization {
            name: "repository-std-only",
            origin_coverage: origins(1_854, 416, 1_480, 803, 294, 10_832, 22_742),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                31_712, 330, 14_562, 13_576, 2_472, 472, 196, 0, 104, 51,
            ),
            row_coverage: row_coverage(70, 51, 102, 343, 43, 43, 592, 77, 0),
            bound_disposition_coverage: bound_dispositions(231_679, 35, 1_875, 0),
            stable_record_coverage: stable_records(113_489, 118_190, 35, 111),
            replay_derivation_coverage: replay_derivations(881_176, 768_728),
            provenance_epoch: 1_411_729,
            canonical_subtype_constraints: 143_166,
            subtype_duplicate_admissions: 13_125,
            subtype_trivial_admissions: 12_103,
            ordinary_lower_bounds_added: 113_489,
            ordinary_upper_bounds_added: 118_139,
            ...
            lower_replay: replay(493_045, 493_045, 27_934, 0, 457_380, 7_731, 465_073),
            upper_replay: replay(388_131, 388_131, 69_059, 0, 311_348, 7_724, 319_034),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 12_657_945_254_254_159_414,
            check_report_fnv1a64: 14_423_990_542_467_323_124,
        },
        ConstraintCharacterization {
            name: "effect-callback-residual",
            origin_coverage: origins(1_857, 416, 1_480, 803, 297, 10_882, 22_809),
            body_requirement_coverage: body_requirements(99),
            structural_coverage: structural(
                31_777, 331, 14_570, 13_620, 2_472, 472, 196, 0, 116, 61,
            ),
            row_coverage: row_coverage(70, 61, 124, 343, 43, 43, 615, 89, 0),
            bound_disposition_coverage: bound_dispositions(232_328, 35, 1_892, 0),
            stable_record_coverage: stable_records(113_786, 118_542, 35, 112),
            replay_derivation_coverage: replay_derivations(881_926, 769_204),
            provenance_epoch: 1_414_074,
            canonical_subtype_constraints: 143_612,
            subtype_duplicate_admissions: 13_197,
            subtype_trivial_admissions: 12_132,
            ordinary_lower_bounds_added: 113_786,
            ordinary_upper_bounds_added: 118_481,
            ...
            row_residuals_created: 70,
            row_residuals_reused: 0,
            lower_replay: replay(493_445, 493_445, 28_033, 0, 457_675, 7_737, 465_374),
            upper_replay: replay(388_481, 388_481, 69_222, 0, 311_529, 7_730, 319_221),
            nominal_cast_events: 2,
            nominal_cast_pairs: vec![
                pair("int", "float", 1),
                pair("int", "std::text::str::str", 1),
            ],
            poly_dump_fnv1a64: 11_230_191_767_757_330_685,
            check_report_fnv1a64: 4_247_855_809_281_191_908,
        },
        ConstraintCharacterization {
            name: "ref-update-local-buffer",
            origin_coverage: origins(1_870, 416, 1_487, 807, 294, 10_945, 22_983),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_239, 332, 15_782, 13_720, 2_594, 472, 200, 0, 139, 74,
            ),
            row_coverage: row_coverage(71, 74, 231, 343, 43, 43, 639, 183, 0),
            bound_disposition_coverage: bound_dispositions(234_913, 35, 1_898, 5),
            stable_record_coverage: stable_records(115_125, 119_788, 35, 112),
            replay_derivation_coverage: replay_derivations(897_840, 783_407),
            provenance_epoch: 1_436_960,
            canonical_subtype_constraints: 145_734,
            subtype_duplicate_admissions: 14_143,
            subtype_trivial_admissions: 12_254,
            ordinary_lower_bounds_added: 115_125,
            ordinary_upper_bounds_added: 119_722,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(500_458, 500_458, 28_492, 0, 463_955, 8_011, 471_928),
            upper_replay: replay(397_382, 397_382, 69_940, 0, 319_452, 7_990, 327_404),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 12_194_674_074_620_842_218,
            check_report_fnv1a64: 890_394_259_576_746_992,
        },
        ConstraintCharacterization {
            name: "config-read-false-positive-repro",
            origin_coverage: origins(1_908, 430, 1_506, 825, 303, 11_300, 23_736),
            body_requirement_coverage: body_requirements(101),
            structural_coverage: structural(
                33_274, 338, 14_922, 14_088, 2_936, 496, 204, 0, 290, 91,
            ),
            row_coverage: row_coverage(74, 91, 231, 343, 43, 43, 680, 162, 0),
            bound_disposition_coverage: bound_dispositions(241_154, 35, 1_883, 0),
            stable_record_coverage: stable_records(118_250, 122_904, 35, 115),
            replay_derivation_coverage: replay_derivations(907_246, 789_245),
            provenance_epoch: 1_459_842,
            canonical_subtype_constraints: 149_607,
            subtype_duplicate_admissions: 13_949,
            subtype_trivial_admissions: 12_627,
            ordinary_lower_bounds_added: 118_250,
            ordinary_upper_bounds_added: 122_813,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(505_109, 505_109, 29_191, 0, 467_525, 8_393, 475_880),
            upper_replay: replay(402_137, 402_137, 72_126, 0, 321_720, 8_291, 329_973),
            ...
            poly_dump_fnv1a64: 18_377_188_611_009_820_158,
            check_report_fnv1a64: 2_450_070_248_209_308_889,
        },
        ConstraintCharacterization {
            name: "file-rollback-false-positive-repro",
            origin_coverage: origins(1_885, 418, 1_497, 813, 294, 11_077, 23_316),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_213, 337, 15_466, 13_844, 2_712, 476, 202, 0, 176, 82,
            ),
            row_coverage: row_coverage(73, 82, 246, 343, 44, 44, 660, 190, 0),
            bound_disposition_coverage: bound_dispositions(236_571, 35, 1_885, 5),
            stable_record_coverage: stable_records(115_972, 120_599, 35, 115),
            replay_derivation_coverage: replay_derivations(894_820, 779_594),
            provenance_epoch: 1_437_675,
            canonical_subtype_constraints: 146_756,
            subtype_duplicate_admissions: 14_083,
            subtype_trivial_admissions: 12_401,
            ordinary_lower_bounds_added: 115_972,
            ordinary_upper_bounds_added: 120_517,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(499_311, 499_311, 28_576, 0, 462_613, 8_122, 470_697),
            upper_replay: replay(395_509, 395_509, 70_459, 0, 316_981, 8_069, 325_012),
            ...
            poly_dump_fnv1a64: 4_466_233_791_842_418_078,
