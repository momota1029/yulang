...
fn expected_characterization() -> Vec<ConstraintCharacterization> {
    ...
    vec![
        ...
        ConstraintCharacterization {
            ...
            replay_derivation_coverage: replay_derivations(897_274, 5, 782_854),
            provenance_epoch: 2_446_796,
            canonical_subtype_constraints: 145_698,
            ...
            upper_replay: replay(396_909, 396_909, 69_944, 0, 318_981, 7_984, 326_927),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
        ...
        ConstraintCharacterization {
            ...
            replay_derivation_coverage: replay_derivations(894_010, 0, 778_872),
            provenance_epoch: 2_440_266,
            canonical_subtype_constraints: 146_760,
            ...
            upper_replay: replay(394_986, 394_986, 70_441, 0, 316_484, 8_061, 324_507),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
