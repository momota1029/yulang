...
fn expected_characterization() -> Vec<ConstraintCharacterization> {
    ...
    vec![
        ConstraintCharacterization {
            name: "repository-std-only",
            origin_coverage: origins(1_853, 416, 1_480, 803, 294, 10_834, 22_741),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                31_710, 330, 14_562, 13_576, 2_470, 472, 196, 0, 104, 51,
            ),
            row_coverage: row_coverage(70, 51, 102, 343, 43, 43, 592, 77, 0),
            bound_disposition_coverage: bound_dispositions(231_542, 35, 1_875, 0),
            stable_record_coverage: stable_records(113_419, 118_123, 35, 111),
            replay_derivation_coverage: replay_derivations(880_522, 768_185),
            provenance_epoch: 1_410_798,
            canonical_subtype_constraints: 143_091,
            subtype_duplicate_admissions: 13_122,
            subtype_trivial_admissions: 12_105,
            ordinary_lower_bounds_added: 113_419,
            ordinary_upper_bounds_added: 118_072,
            ...
            lower_replay: replay(492_659, 492_659, 27_918, 0, 457_029, 7_712, 464_703),
            upper_replay: replay(387_863, 387_863, 69_002, 0, 311_156, 7_705, 318_823),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 7_029_357_166_387_751_379,
            check_report_fnv1a64: 14_423_990_542_467_323_124,
        },
        ConstraintCharacterization {
            name: "effect-callback-residual",
            origin_coverage: origins(1_856, 416, 1_480, 803, 297, 10_884, 22_808),
            body_requirement_coverage: body_requirements(99),
            structural_coverage: structural(
                31_775, 331, 14_570, 13_620, 2_470, 472, 196, 0, 116, 61,
            ),
            row_coverage: row_coverage(70, 61, 124, 343, 43, 43, 615, 89, 0),
            bound_disposition_coverage: bound_dispositions(232_191, 35, 1_892, 0),
            stable_record_coverage: stable_records(113_716, 118_475, 35, 112),
            replay_derivation_coverage: replay_derivations(881_272, 768_661),
            provenance_epoch: 1_413_143,
            canonical_subtype_constraints: 143_537,
            subtype_duplicate_admissions: 13_194,
            subtype_trivial_admissions: 12_134,
            ordinary_lower_bounds_added: 113_716,
            ordinary_upper_bounds_added: 118_414,
            row_upper_bounds_added_without_replay: 61,
            evidence_lower_bounds_added: 0,
            evidence_upper_bounds_added: 0,
            subtract_fact_calls: 112,
            subtract_facts_added: 112,
            row_residuals_created: 70,
            row_residuals_reused: 0,
            lower_replay: replay(493_059, 493_059, 28_017, 0, 457_324, 7_718, 465_004),
            upper_replay: replay(388_213, 388_213, 69_165, 0, 311_337, 7_711, 319_010),
            nominal_cast_events: 2,
            nominal_cast_pairs: vec![
                pair("int", "float", 1),
                pair("int", "std::text::str::str", 1),
            ],
            poly_dump_fnv1a64: 6_337_779_294_550_589_818,
            check_report_fnv1a64: 4_247_855_809_281_191_908,
        },
        ConstraintCharacterization {
            name: "ref-update-local-buffer",
            origin_coverage: origins(1_869, 416, 1_487, 807, 294, 10_947, 22_982),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_237, 332, 15_782, 13_720, 2_592, 472, 200, 0, 139, 74,
            ),
            row_coverage: row_coverage(71, 74, 231, 343, 43, 43, 639, 183, 0),
            bound_disposition_coverage: bound_dispositions(234_776, 35, 1_898, 5),
            stable_record_coverage: stable_records(115_055, 119_721, 35, 112),
            replay_derivation_coverage: replay_derivations(897_186, 782_864),
            provenance_epoch: 1_436_029,
            canonical_subtype_constraints: 145_659,
            subtype_duplicate_admissions: 14_140,
            subtype_trivial_admissions: 12_256,
            ordinary_lower_bounds_added: 115_055,
            ordinary_upper_bounds_added: 119_655,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(500_072, 500_072, 28_476, 0, 463_604, 7_992, 471_558),
            upper_replay: replay(397_114, 397_114, 69_883, 0, 319_260, 7_971, 327_193),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 17_389_382_966_801_665_511,
            check_report_fnv1a64: 890_394_259_576_746_992,
        },
        ConstraintCharacterization {
            name: "config-read-false-positive-repro",
            origin_coverage: origins(1_907, 430, 1_506, 825, 303, 11_302, 23_735),
            body_requirement_coverage: body_requirements(101),
            structural_coverage: structural(
                33_272, 338, 14_922, 14_088, 2_934, 496, 204, 0, 290, 91,
            ),
            row_coverage: row_coverage(74, 91, 231, 343, 43, 43, 680, 162, 0),
            bound_disposition_coverage: bound_dispositions(241_017, 35, 1_883, 0),
            stable_record_coverage: stable_records(118_180, 122_837, 35, 115),
            replay_derivation_coverage: replay_derivations(906_592, 788_702),
            provenance_epoch: 1_458_911,
            canonical_subtype_constraints: 149_532,
            subtype_duplicate_admissions: 13_946,
            subtype_trivial_admissions: 12_629,
            ordinary_lower_bounds_added: 118_180,
            ordinary_upper_bounds_added: 122_746,
            row_upper_bounds_added_without_replay: 91,
            evidence_lower_bounds_added: 0,
            evidence_upper_bounds_added: 0,
            subtract_fact_calls: 115,
            subtract_facts_added: 115,
            row_residuals_created: 74,
            row_residuals_reused: 0,
            lower_replay: replay(504_723, 504_723, 29_175, 0, 467_174, 8_374, 475_510),
            upper_replay: replay(401_869, 401_869, 72_069, 0, 321_528, 8_272, 329_762),
            ...
            poly_dump_fnv1a64: 7_002_799_288_319_926_659,
            check_report_fnv1a64: 2_450_070_248_209_308_889,
        },
        ConstraintCharacterization {
            name: "file-rollback-false-positive-repro",
            origin_coverage: origins(1_884, 418, 1_497, 813, 294, 11_079, 23_315),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_211, 337, 15_466, 13_844, 2_710, 476, 202, 0, 176, 82,
            ),
            row_coverage: row_coverage(73, 82, 246, 343, 44, 44, 660, 190, 0),
            bound_disposition_coverage: bound_dispositions(236_434, 35, 1_885, 5),
            stable_record_coverage: stable_records(115_902, 120_532, 35, 115),
            replay_derivation_coverage: replay_derivations(894_166, 779_051),
            provenance_epoch: 1_436_744,
            canonical_subtype_constraints: 146_681,
            subtype_duplicate_admissions: 14_080,
            subtype_trivial_admissions: 12_403,
            ordinary_lower_bounds_added: 115_902,
            ordinary_upper_bounds_added: 120_450,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(498_925, 498_925, 28_560, 0, 462_262, 8_103, 470_327),
            upper_replay: replay(395_241, 395_241, 70_402, 0, 316_789, 8_050, 324_801),
            ...
            poly_dump_fnv1a64: 9_343_941_243_297_222_537,
            check_report_fnv1a64: 11_064_960_632_935_954_575,
        },
    ]
}
