...
fn expected_characterization() -> Vec<ConstraintCharacterization> {
    ...
    vec![
        ConstraintCharacterization {
            name: "repository-std-only",
            origin_coverage: origins(1_855, 416, 1_468, 803, 294, 10_843, 22_756),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                31_750, 330, 14_552, 13_612, 2_472, 484, 196, 0, 104, 51,
            ),
            row_coverage: row_coverage(70, 51, 102, 343, 43, 43, 592, 77, 0),
            bound_disposition_coverage: bound_dispositions(231_706, 35, 1_875, 0),
            stable_record_coverage: stable_records(113_495, 118_211, 35, 107),
            replay_derivation_coverage: replay_derivations(881_061, 768_623),
            provenance_epoch: 1_411_708,
            canonical_subtype_constraints: 143_180,
            subtype_duplicate_admissions: 13_138,
            subtype_trivial_admissions: 12_118,
            ordinary_lower_bounds_added: 113_495,
            ordinary_upper_bounds_added: 118_160,
            ...
            lower_replay: replay(493_004, 493_004, 27_936, 0, 457_338, 7_730, 465_030),
            upper_replay: replay(388_057, 388_057, 69_049, 0, 311_285, 7_723, 318_970),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 8_670_997_164_401_485_156,
            check_report_fnv1a64: 5_811_326_162_228_699_395,
        },
        ConstraintCharacterization {
            name: "effect-callback-residual",
            origin_coverage: origins(1_858, 416, 1_468, 803, 297, 10_893, 22_823),
            body_requirement_coverage: body_requirements(99),
            structural_coverage: structural(
                31_815, 331, 14_560, 13_656, 2_472, 484, 196, 0, 116, 61,
            ),
            row_coverage: row_coverage(70, 61, 124, 343, 43, 43, 615, 89, 0),
            bound_disposition_coverage: bound_dispositions(232_355, 35, 1_892, 0),
            stable_record_coverage: stable_records(113_792, 118_563, 35, 108),
            replay_derivation_coverage: replay_derivations(881_811, 769_099),
            provenance_epoch: 1_414_053,
            canonical_subtype_constraints: 143_626,
            subtype_duplicate_admissions: 13_210,
            subtype_trivial_admissions: 12_147,
            ordinary_lower_bounds_added: 113_792,
            ordinary_upper_bounds_added: 118_502,
            ...
            row_residuals_created: 70,
            row_residuals_reused: 0,
            lower_replay: replay(493_404, 493_404, 28_035, 0, 457_633, 7_736, 465_331),
            upper_replay: replay(388_407, 388_407, 69_212, 0, 311_466, 7_729, 319_157),
            nominal_cast_events: 2,
            nominal_cast_pairs: vec![
                pair("int", "float", 1),
                pair("int", "std::text::str::str", 1),
            ],
            poly_dump_fnv1a64: 12_648_975_282_339_493_002,
            check_report_fnv1a64: 15_043_926_579_654_723_785,
        },
        ConstraintCharacterization {
            name: "ref-update-local-buffer",
            origin_coverage: origins(1_871, 416, 1_475, 807, 294, 10_956, 22_997),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_277, 332, 15_772, 13_756, 2_594, 484, 200, 0, 139, 74,
            ),
            row_coverage: row_coverage(71, 74, 231, 343, 43, 43, 639, 183, 0),
            bound_disposition_coverage: bound_dispositions(234_940, 35, 1_898, 5),
            stable_record_coverage: stable_records(115_131, 119_809, 35, 108),
            replay_derivation_coverage: replay_derivations(897_725, 783_302),
            provenance_epoch: 1_436_939,
            canonical_subtype_constraints: 145_748,
            subtype_duplicate_admissions: 14_156,
            subtype_trivial_admissions: 12_269,
            ordinary_lower_bounds_added: 115_131,
            ordinary_upper_bounds_added: 119_743,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(500_417, 500_417, 28_494, 0, 463_913, 8_010, 471_885),
            upper_replay: replay(397_308, 397_308, 69_930, 0, 319_389, 7_989, 327_340),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 10_083_279_399_231_108_481,
            check_report_fnv1a64: 9_910_688_348_905_276_119,
        },
        ConstraintCharacterization {
            name: "config-read-false-positive-repro",
            origin_coverage: origins(1_909, 430, 1_494, 825, 303, 11_311, 23_750),
            body_requirement_coverage: body_requirements(101),
            structural_coverage: structural(
                33_312, 338, 14_912, 14_124, 2_936, 508, 204, 0, 290, 91,
            ),
            row_coverage: row_coverage(74, 91, 231, 343, 43, 43, 680, 162, 0),
            bound_disposition_coverage: bound_dispositions(241_181, 35, 1_883, 0),
            stable_record_coverage: stable_records(118_256, 122_925, 35, 111),
            replay_derivation_coverage: replay_derivations(907_131, 789_140),
            provenance_epoch: 1_459_821,
            canonical_subtype_constraints: 149_621,
            subtype_duplicate_admissions: 13_962,
            subtype_trivial_admissions: 12_642,
            ordinary_lower_bounds_added: 118_256,
            ordinary_upper_bounds_added: 122_834,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(505_068, 505_068, 29_193, 0, 467_483, 8_392, 475_837),
            upper_replay: replay(402_063, 402_063, 72_116, 0, 321_657, 8_290, 329_909),
            ...
            poly_dump_fnv1a64: 12_802_958_861_463_592_143,
            check_report_fnv1a64: 9_427_357_688_901_659_345,
        },
        ConstraintCharacterization {
            name: "file-rollback-false-positive-repro",
            origin_coverage: origins(1_886, 418, 1_485, 813, 294, 11_088, 23_330),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_251, 337, 15_456, 13_880, 2_712, 488, 202, 0, 176, 82,
            ),
            row_coverage: row_coverage(73, 82, 246, 343, 44, 44, 660, 190, 0),
            bound_disposition_coverage: bound_dispositions(236_598, 35, 1_885, 5),
            stable_record_coverage: stable_records(115_978, 120_620, 35, 111),
            replay_derivation_coverage: replay_derivations(894_705, 779_489),
            provenance_epoch: 1_437_654,
            canonical_subtype_constraints: 146_770,
            subtype_duplicate_admissions: 14_096,
            subtype_trivial_admissions: 12_416,
            ordinary_lower_bounds_added: 115_978,
            ordinary_upper_bounds_added: 120_538,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(499_270, 499_270, 28_578, 0, 462_571, 8_121, 470_654),
            upper_replay: replay(395_435, 395_435, 70_449, 0, 316_918, 8_068, 324_948),
            ...
            poly_dump_fnv1a64: 3_842_714_890_188_109_044,
