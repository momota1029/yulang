...
fn expected_characterization() -> Vec<ConstraintCharacterization> {
    ...
    vec![
        ConstraintCharacterization {
            name: "repository-std-only",
            origin_coverage: origins(1_855, 416, 1_480, 803, 294, 10_843, 22_756),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                31_752, 330, 14_562, 13_612, 2_472, 476, 196, 0, 104, 51,
            ),
            row_coverage: row_coverage(70, 51, 102, 343, 43, 43, 592, 77, 0),
            bound_disposition_coverage: bound_dispositions(231_750, 35, 1_875, 0),
            stable_record_coverage: stable_records(113_517, 118_233, 35, 107),
            replay_derivation_coverage: replay_derivations(881_201, 768_735),
            provenance_epoch: 1_411_945,
            canonical_subtype_constraints: 143_224,
            subtype_duplicate_admissions: 13_134,
            subtype_trivial_admissions: 12_118,
            ordinary_lower_bounds_added: 113_517,
            ordinary_upper_bounds_added: 118_182,
            ...
            lower_replay: replay(493_052, 493_052, 27_937, 0, 457_384, 7_731, 465_077),
            upper_replay: replay(388_149, 388_149, 69_074, 0, 311_351, 7_724, 319_037),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 4_740_178_589_782_694_735,
            check_report_fnv1a64: 5_811_326_162_228_699_395,
        },
        ConstraintCharacterization {
            name: "effect-callback-residual",
            origin_coverage: origins(1_858, 416, 1_480, 803, 297, 10_893, 22_823),
            body_requirement_coverage: body_requirements(99),
            structural_coverage: structural(
                31_817, 331, 14_570, 13_656, 2_472, 476, 196, 0, 116, 61,
            ),
            row_coverage: row_coverage(70, 61, 124, 343, 43, 43, 615, 89, 0),
            bound_disposition_coverage: bound_dispositions(232_399, 35, 1_892, 0),
            stable_record_coverage: stable_records(113_814, 118_585, 35, 108),
            replay_derivation_coverage: replay_derivations(881_951, 769_211),
            provenance_epoch: 1_414_290,
            canonical_subtype_constraints: 143_670,
            subtype_duplicate_admissions: 13_206,
            subtype_trivial_admissions: 12_147,
            ordinary_lower_bounds_added: 113_814,
            ordinary_upper_bounds_added: 118_524,
            ...
            row_residuals_created: 70,
            row_residuals_reused: 0,
            lower_replay: replay(493_452, 493_452, 28_036, 0, 457_679, 7_737, 465_378),
            upper_replay: replay(388_499, 388_499, 69_237, 0, 311_532, 7_730, 319_224),
            nominal_cast_events: 2,
            nominal_cast_pairs: vec![
                pair("int", "float", 1),
                pair("int", "std::text::str::str", 1),
            ],
            poly_dump_fnv1a64: 9_005_238_727_967_993_237,
            check_report_fnv1a64: 15_043_926_579_654_723_785,
        },
        ConstraintCharacterization {
            name: "ref-update-local-buffer",
            origin_coverage: origins(1_871, 416, 1_487, 807, 294, 10_956, 22_997),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_279, 332, 15_782, 13_756, 2_594, 476, 200, 0, 139, 74,
            ),
            row_coverage: row_coverage(71, 74, 231, 343, 43, 43, 639, 183, 0),
            bound_disposition_coverage: bound_dispositions(234_984, 35, 1_898, 5),
            stable_record_coverage: stable_records(115_153, 119_831, 35, 108),
            replay_derivation_coverage: replay_derivations(897_865, 783_414),
            provenance_epoch: 1_437_176,
            canonical_subtype_constraints: 145_792,
            subtype_duplicate_admissions: 14_152,
            subtype_trivial_admissions: 12_269,
            ordinary_lower_bounds_added: 115_153,
            ordinary_upper_bounds_added: 119_765,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(500_465, 500_465, 28_495, 0, 463_959, 8_011, 471_932),
            upper_replay: replay(397_400, 397_400, 69_955, 0, 319_455, 7_990, 327_407),
            nominal_cast_events: 1,
            nominal_cast_pairs: vec![pair("int", "float", 1)],
            poly_dump_fnv1a64: 17_698_012_839_478_812_866,
            check_report_fnv1a64: 9_910_688_348_905_276_119,
        },
        ConstraintCharacterization {
            name: "config-read-false-positive-repro",
            origin_coverage: origins(1_909, 430, 1_506, 825, 303, 11_311, 23_750),
            body_requirement_coverage: body_requirements(101),
            structural_coverage: structural(
                33_314, 338, 14_922, 14_124, 2_936, 500, 204, 0, 290, 91,
            ),
            row_coverage: row_coverage(74, 91, 231, 343, 43, 43, 680, 162, 0),
            bound_disposition_coverage: bound_dispositions(241_225, 35, 1_883, 0),
            stable_record_coverage: stable_records(118_278, 122_947, 35, 111),
            replay_derivation_coverage: replay_derivations(907_271, 789_252),
            provenance_epoch: 1_460_058,
            canonical_subtype_constraints: 149_665,
            subtype_duplicate_admissions: 13_958,
            subtype_trivial_admissions: 12_642,
            ordinary_lower_bounds_added: 118_278,
            ordinary_upper_bounds_added: 122_856,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(505_116, 505_116, 29_194, 0, 467_529, 8_393, 475_884),
            upper_replay: replay(402_155, 402_155, 72_141, 0, 321_723, 8_291, 329_976),
            ...
            poly_dump_fnv1a64: 8_486_102_242_257_431_148,
            check_report_fnv1a64: 9_427_357_688_901_659_345,
        },
        ConstraintCharacterization {
            name: "file-rollback-false-positive-repro",
            origin_coverage: origins(1_886, 418, 1_497, 813, 294, 11_088, 23_330),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_253, 337, 15_466, 13_880, 2_712, 480, 202, 0, 176, 82,
            ),
            row_coverage: row_coverage(73, 82, 246, 343, 44, 44, 660, 190, 0),
            bound_disposition_coverage: bound_dispositions(236_642, 35, 1_885, 5),
            stable_record_coverage: stable_records(116_000, 120_642, 35, 111),
            replay_derivation_coverage: replay_derivations(894_845, 779_601),
            provenance_epoch: 1_437_891,
            canonical_subtype_constraints: 146_814,
            subtype_duplicate_admissions: 14_092,
            subtype_trivial_admissions: 12_416,
            ordinary_lower_bounds_added: 116_000,
            ordinary_upper_bounds_added: 120_560,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(499_318, 499_318, 28_579, 0, 462_617, 8_122, 470_701),
            upper_replay: replay(395_527, 395_527, 70_474, 0, 316_984, 8_069, 325_015),
            ...
            poly_dump_fnv1a64: 8_125_651_583_364_234_263,
