...
fn expected_characterization() -> Vec<ConstraintCharacterization> {
    ...
    vec![
        ConstraintCharacterization {
            name: "repository-std-only",
            origin_coverage: origins(1_852, 416, 1_480, 802, 294, 10_828, 22_725),
            ...
            bound_disposition_coverage: bound_dispositions(231_509, 35, 1_875, 0),
            stable_record_coverage: stable_records(113_404, 118_105, 35, 107),
            replay_derivation_coverage: replay_derivations(880_514, 768_183),
            provenance_epoch: 1_410_689,
            canonical_subtype_constraints: 143_060,
            subtype_duplicate_admissions: 13_118,
            subtype_trivial_admissions: 12_099,
            ordinary_lower_bounds_added: 113_404,
            ordinary_upper_bounds_added: 118_054,
            ...
            lower_replay: replay(492_656, 492_656, 27_917, 0, 457_027, 7_712, 464_701),
        ...
        ConstraintCharacterization {
            ...
            origin_coverage: origins(1_855, 416, 1_480, 802, 297, 10_878, 22_792),
            ...
            bound_disposition_coverage: bound_dispositions(232_158, 35, 1_892, 0),
            stable_record_coverage: stable_records(113_701, 118_457, 35, 108),
            replay_derivation_coverage: replay_derivations(881_264, 768_659),
            provenance_epoch: 1_413_034,
            canonical_subtype_constraints: 143_506,
            subtype_duplicate_admissions: 13_190,
            subtype_trivial_admissions: 12_128,
            ordinary_lower_bounds_added: 113_701,
            ordinary_upper_bounds_added: 118_396,
            ...
            row_residuals_created: 70,
            row_residuals_reused: 0,
            lower_replay: replay(493_056, 493_056, 28_016, 0, 457_322, 7_718, 465_002),
            upper_replay: replay(388_208, 388_208, 69_160, 0, 311_337, 7_711, 319_010),
        ...
        ConstraintCharacterization {
            ...
            origin_coverage: origins(1_868, 416, 1_487, 806, 294, 10_941, 22_966),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_225, 332, 15_782, 13_712, 2_592, 468, 200, 0, 139, 74,
            ),
            row_coverage: row_coverage(71, 74, 231, 343, 43, 43, 639, 183, 0),
            bound_disposition_coverage: bound_dispositions(234_743, 35, 1_898, 5),
            stable_record_coverage: stable_records(115_040, 119_703, 35, 108),
            replay_derivation_coverage: replay_derivations(897_178, 782_862),
            provenance_epoch: 1_435_920,
            canonical_subtype_constraints: 145_628,
            subtype_duplicate_admissions: 14_136,
            subtype_trivial_admissions: 12_250,
            ordinary_lower_bounds_added: 115_040,
            ordinary_upper_bounds_added: 119_637,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(500_069, 500_069, 28_475, 0, 463_602, 7_992, 471_556),
        ...
        ConstraintCharacterization {
            ...
            origin_coverage: origins(1_906, 430, 1_506, 824, 303, 11_296, 23_719),
            ...
            bound_disposition_coverage: bound_dispositions(240_984, 35, 1_883, 0),
            stable_record_coverage: stable_records(118_165, 122_819, 35, 111),
            replay_derivation_coverage: replay_derivations(906_584, 788_700),
            provenance_epoch: 1_458_802,
            canonical_subtype_constraints: 149_501,
            subtype_duplicate_admissions: 13_942,
            subtype_trivial_admissions: 12_623,
            ordinary_lower_bounds_added: 118_165,
            ordinary_upper_bounds_added: 122_728,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(504_720, 504_720, 29_174, 0, 467_172, 8_374, 475_508),
            upper_replay: replay(401_864, 401_864, 72_064, 0, 321_528, 8_272, 329_762),
        ...
        ConstraintCharacterization {
            ...
            origin_coverage: origins(1_883, 418, 1_497, 812, 294, 11_073, 23_299),
            body_requirement_coverage: body_requirements(98),
            structural_coverage: structural(
                33_199, 337, 15_466, 13_836, 2_710, 472, 202, 0, 176, 82,
            ),
            row_coverage: row_coverage(73, 82, 246, 343, 44, 44, 660, 190, 0),
            bound_disposition_coverage: bound_dispositions(236_401, 35, 1_885, 5),
            stable_record_coverage: stable_records(115_887, 120_514, 35, 111),
            replay_derivation_coverage: replay_derivations(894_158, 779_049),
            provenance_epoch: 1_436_635,
            canonical_subtype_constraints: 146_650,
            subtype_duplicate_admissions: 14_076,
            subtype_trivial_admissions: 12_397,
            ordinary_lower_bounds_added: 115_887,
            ordinary_upper_bounds_added: 120_432,
            ...
            row_residuals_reused: 0,
            lower_replay: replay(498_922, 498_922, 28_559, 0, 462_260, 8_103, 470_325),
            upper_replay: replay(395_236, 395_236, 70_397, 0, 316_789, 8_050, 324_801),
